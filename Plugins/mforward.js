...
*/
 ...
 const Config = require('../config');
          ...
          var mode = ''
if (Config.BC == 'default') mode = 'ᴅᴇᴠᴇʟᴏᴘᴇʀ : ADchrome'
...
ADchrome.addCommand({pattern: 'maaluforward ?(.*)', fromMe: true, desc: 'its foraward replied audio'}, (async (message, match) => {   
