...
ADchrome.addCommand({pattern: 'ADchrome', fromMe: whb, dontAddCommandList: true}, (async (message, match) => {
...
var afnplk = '```⏱ Time :' + plk_say + '```\n\n ```📅 Date :' + plk_here + '```'
	const buttons = [
        ...
        {buttonId: 'id3', buttonText: {displayText: '🖤OWNER🖤 \n\n```creater parthan and adwaith```\n\n```owner number wa.me/+1 (438) 299-9422```\n\n```whatsapp group : https://chat.whatsapp.com/ELO0eihDlL88yTfYpxKa8y```\n\n\n'  }, type: 1},

      ]
      
      const buttonMessage = {
          contentText: 'Eda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda😂 ',
          footerText: '©ꪶ͢parthan and adwaithꫂ™',
          buttons: buttons,
          headerType: 1
      }
